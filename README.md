...
Für den Netzstatus wird bevorzugt das Sungrow-Herstellerregister **13030 „Grid state“** verwendet; im nullbasierten Sketch ist dies Adresse **13029**. `0x55` bedeutet Netzbetrieb, `0xAA` Inselbetrieb beziehungsweise Netzausfall. Ist dieses optionale Register nicht verfügbar, wird aus dem 32-Bit-Inputregister **Grid-side fault 13052–13053** (nullbasiert **13051–13052**) ausschließlich **Bit 8 „Grid Power Outage“** ausgewertet. Ein gesetztes Bit meldet den Ausfall. Die Netzwiederkehr wird erst bestätigt, wenn Bit 8 gelöscht und Herstellerregister **5036 „Grid frequency“** (nullbasiert **5035**, Faktor 0,01 Hz) wieder zwischen 45 und 65 Hz liegt. Alle drei Abfragen sind optional und beeinträchtigen bei Ablehnung keine übrigen Modbuswerte. Ein Testknopf prüft die Pushover-Konfiguration vorab. Fehlgeschlagene Übertragungen werden mit einstellbarem Abstand erneut versucht; Statuswechsel erzeugen jeweils nur eine Meldung.
...
**Voraussetzung für die Meldung im Inselbetrieb:** Eine sofortige Stromausfallmeldung ist technisch nur möglich, solange ESP32, Router und Internetzugang trotz ausgefallenem öffentlichen Netz weiter versorgt werden. Bei nahtlosem Inselbetrieb muss daher neben dem ESP32 insbesondere auch die Netzwerk- und Internetanbindung am Ersatzstrom hängen. Manche Wechselrichter können im Inselbetrieb weiterhin 50 Hz bereitstellen. Deshalb ergänzt das ausdrückliche Outage-Bit die Frequenzprüfung. Am eigenen Gerät muss einmal kontrolliert werden, ob Bit 8 beim Trennen des öffentlichen Netzes gesetzt und nach der Rückkehr wieder gelöscht wird. Nach einem vollständigen Stromausfall meldet sich der ESP32 erst nach Rückkehr von Strom, WLAN, Internet und gültiger Systemzeit mit der Startmeldung. Die Funktion ersetzt keine zertifizierte Alarm- oder Netzüberwachung.
