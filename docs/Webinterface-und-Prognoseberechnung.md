...
Die Ausfallverzögerung unterdrückt kurze Modbus- und Netzstatusstörungen. Bevorzugt stammt der Netzstatus aus dem Sungrow-Herstellerregister 13030, das im nullbasierten Sketch als Adresse 13029 gelesen wird: `0x55` steht für Netzbetrieb, `0xAA` für Inselbetrieb/Netzausfall. Ist dieser optionale Wert nicht verfügbar, wird Herstellerregister 5036 „Grid frequency“ nullbasiert über Adresse 5035 und mit Faktor 0,1 Hz gelesen. Eine frische Frequenz von 45 bis 65 Hz gilt als vorhanden; ein Wert darunter oder darüber als möglicher Netzausfall. Beide Blöcke sind optional, damit abweichende Firmwarestände die übrige Abfrage nicht blockieren. Nach erfolgreicher Ausfallmeldung entsteht keine wiederholte Dauermeldung; nach Wiederherstellung folgt genau ein weiterer Zustandswechsel. Das Datum eines erfolgreich gesendeten Tagesberichts bleibt im NVS gespeichert und verhindert eine Doppelmeldung nach Neustart. Scheitert die HTTPS-Übertragung, bestimmt der Wiederholungsabstand den nächsten Versuch. Der Testknopf prüft neue Eingaben ohne vorheriges Speichern. Der offizielle Pushover-Endpunkt wird per HTTPS mit Zertifikatsprüfung angesprochen.
